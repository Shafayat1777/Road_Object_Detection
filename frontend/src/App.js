  ...
  return (
    <div className=" h-screen flex justify-center">
      <div className="border w-[1100px]">
        <div className="">
          <h1 className="text-center text-2xl p-2 font-semibold">Object Detection Demo using YOLOv7</h1>
          <div className="p-5">
            <h1 className="font-semibold p-2">Please upload an image for road object detection and click the detect objects button</h1>
            <input
